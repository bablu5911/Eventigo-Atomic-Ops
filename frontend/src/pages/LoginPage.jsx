        ...
        <div className="bg-white/80 backdrop-blur-md border border-brand-dark/10 p-7 rounded-3xl space-y-4 shadow-sm">
          ...
          <div className="space-y-2.5">
            <button
              ...
              className="w-full py-3 bg-white hover:bg-slate-50 text-brand-dark font-bold rounded-full border border-brand-dark/20 transition-all flex items-center justify-center space-x-2 text-xs uppercase tracking-wider shadow-sm active:scale-[0.99]"
            >
